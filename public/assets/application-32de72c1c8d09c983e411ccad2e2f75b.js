...
(function() {
  ...
  MainRouter = (function(_super) {
    ...
    function MainRouter() {
      ...
      this._extractParameters = __bind(this._extractParameters, this);
      return MainRouter.__super__.constructor.apply(this, arguments);
    }

    MainRouter.prototype.initialize = function(options) {
      return MainRouter.__super__.initialize.call(this, options);
    };
    ...
    MainRouter.prototype._extractParameters = function(route, fragment) {
      var index, k, part, parts, results, _i, _len;
      results = {};
      if (fragment == null) {
        return results;
      }
      ...
      for (index = _i = 0, _len = part.length; _i < _len; index = ++_i) {
        k = part[index];
        if (index % 2 !== 0) {
          continue;
        }
    ...
    MainRouter.prototype.home = function(params) {
      this.params = params;
    };
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/group_error"] = function(locals){
            var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;
  var buf = [];
  with (locals || {}) {
  var interp;
  buf.push('<div');
  buf.push(attrs({ "class": ('alert') + ' ' + ('alert-danger') }));
  buf.push('><h4><This>App requires read permissions on the Facebook Group - </This>');
  var __val__ = group_name
  buf.push(escape(null == __val__ ? "" : __val__));
  buf.push('.\n</h4>Please ensure you are a member of this group. You can do a search for \'Malayalam Songs\' and request access to the group. If you are still a member, and cannot see videos listed, please contact <a href="mailto:support@rightmoveltd.com">support@rightmoveltd.com</a>.\n</div>');
  }
  return buf.join("");
          };
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/play_list"] = function(locals){
            var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;
  var buf = [];
  with (locals || {}) {
  var interp;
  // iterate play_lists
  (function(){
    if ('number' == typeof play_lists.length) {
      for (var $index = 0, $$l = play_lists.length; $index < $$l; $index++) {
        var play_list = play_lists[$index];
  
  buf.push('<li');
  buf.push(attrs({ "class": ('play-list') + ' ' + ('clearfix') }));
  buf.push('><div');
  buf.push(attrs({ "class": ('thumbnail') }));
  buf.push('><a');
  buf.push(attrs({ 'href':("#playlist/{play_list.id}") }));
  buf.push('><span');
  buf.push(attrs({ "class": ('video-thumb') }));
  buf.push('><span');
  buf.push(attrs({ "class": ('video-default') }));
  buf.push('><span');
  buf.push(attrs({ "class": ('video-clip') }));
  buf.push('><img');
  buf.push(attrs({ 'src':(song.image_url), 'alt':('Thumbnail') }));
  buf.push('/><span');
  buf.push(attrs({ "class": ('valign') }));
  buf.push('></span></span></span></span></a></div><div');
  buf.push(attrs({ "class": ('s-content') }));
  buf.push('><h3');
  buf.push(attrs({ "class": ('title') }));
  buf.push('><a><span>');
  var __val__ = song.title
  buf.push(escape(null == __val__ ? "" : __val__));
  buf.push('</span></a></h3><div');
  buf.push(attrs({ "class": ('description') }));
  buf.push('><span>');
  var __val__ = song.description
  buf.push(escape(null == __val__ ? "" : __val__));
  buf.push('</span></div></div></li>');
      }
    } else {
      for (var $index in play_lists) {
        if (play_lists.hasOwnProperty($index)){      var play_list = play_lists[$index];
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/song_list"] = function(locals){
            var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;
  var buf = [];
  with (locals || {}) {
  var interp;
  // iterate songs
  (function(){
    if ('number' == typeof songs.length) {
      for (var $index = 0, $$l = songs.length; $index < $$l; $index++) {
        var song = songs[$index];
  
  buf.push('<li');
  buf.push(attrs({ "class": ('song') + ' ' + ('clearfix') }));
  buf.push('><div');
  buf.push(attrs({ "class": ('checkbox') + ' ' + ('pull-left') }));
  buf.push('><label><input');
  buf.push(attrs({ 'type':("checkbox"), 'value':(song.id), "class": ('videos-selected') }));
  buf.push('/></label></div><div');
  buf.push(attrs({ "class": ('thumbnail') }));
  buf.push('><a');
  buf.push(attrs({ 'href':("#watch/v/" + (song.id) + "") }));
  buf.push('><span');
  buf.push(attrs({ "class": ('video-thumb') }));
  buf.push('><span');
  buf.push(attrs({ "class": ('video-default') }));
  ...
  buf.push(attrs({ "class": ('video-clip') }));
  buf.push('><img');
  buf.push(attrs({ 'src':(song.snippet.thumbnails.high.url), 'alt':('Thumbnail') }));
  buf.push('/><span');
  buf.push(attrs({ "class": ('valign') }));
  buf.push('></span></span></span></span></a></div><div');
  buf.push(attrs({ "class": ('s-content') }));
  ...
  buf.push(attrs({ "class": ('title') }));
  buf.push('><a><span>');
  var __val__ = song.snippet.title
  buf.push(escape(null == __val__ ? "" : __val__));
  buf.push('</span></a></h3><div');
  buf.push(attrs({ "class": ('description') }));
  buf.push('><span>');
  var __val__ = song.snippet.description
  buf.push(escape(null == __val__ ? "" : __val__));
  buf.push('</span></div></div></li>');
      }
    } else {
      for (var $index in songs) {
        if (songs.hasOwnProperty($index)){      var song = songs[$index];
...
(function() {
  ...
  Fb.Models.PlayList = (function(_super) {
  ...
  Fb.Collections.PlayList = (function(_super) {
    __extends(PlayList, _super);
    ...
    PlayList.prototype.model = Fb.Models.PlayList;

    PlayList.prototype.url = '/play_lists';

    PlayList.prototype.mode = 'client';

    PlayList.prototype.state = {
      pageSize: 5
    };
...
(function() {
  ...
  Fb.Models.Song = (function(_super) {
  ...
  Fb.Collections.Song = (function(_super) {
    __extends(Song, _super);
    ...
    Song.prototype.model = Fb.Models.Song;

    Song.prototype.url = '/songs';

    Song.prototype.mode = 'server';

    Song.prototype.state = {
      pageSize: 50
    };
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/views/play_list"] = (function() {
    var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
      __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  
    Fb.Views.PlayList = (function(_super) {
      __extends(PlayList, _super);
      ...
      PlayList.prototype.initialize = function(options) {
        PlayList.__super__.initialize.call(this, options);
        this.router = Fb.Routers.Main;
        this.collection = new Fb.Collections.PlayList();
        this.listenTo(this.router, 'route:home', function(params) {
      ...
      PlayList.prototype.render = function() {
        var list, template;
        if ((list = this.$el.find('ol.play-lists')) && list.length === 0) {
          list = $('<ol class="play-lists"></ol>');
        }
        template = JST['backbone/templates/play_list'];
        list.append(template({
          play_lists: this.collection.toJSON()
        }));
        return this.$el.prepend(list);
      };
...
(function() {
  ...
  Fb.Views.SongList = (function(_super) {
    __extends(SongList, _super);

    function SongList() {
      this.render = __bind(this.render, this);
      this.unrender = __bind(this.unrender, this);
      this.load_videos = __bind(this.load_videos, this);
      this.initialize = __bind(this.initialize, this);
      return SongList.__super__.constructor.apply(this, arguments);
    }

    SongList.prototype.initialize = function(options) {
      var get_next_set, handler, marker, view;
      SongList.__super__.initialize.call(this, options);
      view = this;
      this.listenTo(CGanam.Events, 'group-not-found', this.render_group_access_error);
      this.listenTo(CGanam.Events, 'load-videos', this.load_videos);
      this.listenTo(CGanam.Events, 'feed-pagination-marker', function(group_id, tokens) {
        this.group_id = group_id;
        this.tokens = tokens;
      });
      this.listenTo(CGanam.Events, 'get-song-group', function() {
        return this.marker.addClass('more-songs');
      });
      this.listenTo(CGanam.Events, 'group-not-found', function() {
        return this.marker.removeClass('more-songs');
      });
      this.listenTo(CGanam.Events, 'videos:get-latest', this.unrender);
      this.request_mode = false;
      marker = this.$el.find('#eof');
      get_next_set = function() {
        marker.addClass('more-songs');
        return CGanam.Events.trigger('get-next-set-feed', view.group_id, view.tokens);
      };
      handler = function() {
        var rect;
        rect = marker[0].getBoundingClientRect();
        if (rect.top > 0 && rect.left > 0 && (rect.bottom - 10) <= $(window).height() && rect.right <= $(window).width() && !view.request_mode) {
    ...
    SongList.prototype.load_videos = function(videos) {
      this.marker.removeClass('more-songs');
      return this.render(videos);
    };

    SongList.prototype.events = {
      'click li.song a': 'handle_image_click'
    };

    SongList.prototype.handle_image_click = function(e) {
      e.preventDefault();
      return $(e.target).parents('li.song').find('input.videos-selected').click();
    };

    SongList.prototype.unrender = function() {
      return this.$el.children().not('#eof').remove();
    };

    SongList.prototype.render = function(videos) {
      var list, template;
      if ((list = this.$el.find('ol.song-list')) && list.length === 0) {
    ...
    SongList.prototype.render_group_access_error = function(group_name) {
      var group_access_error_template;
      group_access_error_template = JST['backbone/templates/group_error'];
      return this.$el.prepend(group_access_error_template({
...
(function() {
  ...
  $(function() {
    var songList;
    songList = new Fb.Views.SongList({
      el: '#song-list'
    });
...
(function(){
  ...
  var get_youtube_id = function(link) {
    ...
    if (link) {
      if (link.indexOf('v=') >= 0) {
        ...
        video_id = link.split("youtu.be/")[1].substring(0, 11);
      }
      /*
  ...
  var get_youtube_link = function(feed) {
    if (feed && (feed.type == 'status' or feed.type == 'photo') 
        && feed.message) {
  ...
  var get_song_group = function() {
    FB.api('/me/groups', function(response) {
      ...
      if (!group_found) {
        CGanam.Events.trigger('group-not-found', 'Malayalam Songs');
      }
    });
  };
  ...
  var show_liked = function() {
    //console.log('Show liked ones');
  };
  ...
  CGanam.Group.listenTo(
      CGanam.Events, 'videos:get-latest', refresh);
})();
(function(){
